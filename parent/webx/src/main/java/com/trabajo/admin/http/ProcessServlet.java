...
public class ProcessServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (action) {
			...
			case "purgeService": {
				response.setContentType("application/json");
				engine.purgeService(ts, DefinitionVersion.parse(request.getParameter("dv")));
				response.getWriter().print(status.toJSONAddOK());
				break;
			}
			case "purgeClassLoader": {
				response.setContentType("application/json");
				engine.purgeClassLoader(ts, DefinitionVersion.parse(request.getParameter("dv")));
				response.getWriter().print(status.toJSONAddOK());
				break;
			}
			case "deprecate": {
			...
			case "deprecateService": {
				response.setContentType("application/json");
				engine.deprecateService(ts, DefinitionVersion.parse(request.getParameter("dv")), Boolean.parseBoolean(request.getParameter("deprecate")));
				response.getWriter().print(status.toJSONAddOK());
				break;
			}
			case "deprecateClassLoader": {
				response.setContentType("application/json");
				engine.deprecateClassLoader(ts, DefinitionVersion.parse(request.getParameter("dv")), Boolean.parseBoolean(request.getParameter("deprecate")));
				response.getWriter().print(status.toJSONAddOK());
				break;
			}
			case "suspend": {
			...
			case "setProcessServiceProperty": {
				response.setContentType("application/json");
				engine.setProcessServiceProperty(ts, DefinitionVersion.parse(request.getParameter("processDv")), DefinitionVersion.parse(request.getParameter("serviceDv")),
