...
@Entity(name = "ServiceDef")
@Table(name = "SERVICEDEF")
public class ServiceDefJPA implements JPAProcessComponent<ServiceDefJPA> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ServiceDefJPA other = (ServiceDefJPA) obj;
