...
public class TaskFix {
  ...
  @TaskState private StateContainer stateContainer;
	...
	@TaskLifecycle(phase = ACTION, action = "fixed")
	public void cant() {
		thisTask.end(TaskCompletion.OK, stateContainer);
	}
	...
	public void formData(String args, Writer w) throws IOException {
		...
		jsonElement.getAsJsonObject().addProperty("explainTask", "Fix this bug on the given environment");
