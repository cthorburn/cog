...
import com.trabajo.jpa.JPAProcessComponent;
import com.trabajo.utils.Strings;

public class ProcessComponentTreeBuilder<T extends JPAProcessComponent<T>> {

	private StringBuilder sb = new StringBuilder();
	private String rootLabel;

	public ProcessComponentTreeBuilder(List<T> results, String rootLabel) {
		...
		for (T j : results) {
			...
			v.append('.');
			v.append(j.getDefinitionVersion().getShortName());
			//	v.append(".versions.");
			v.append(".");
			
			v.append(j.getDefinitionVersion().getMajor());
			v.append("-");
			v.append(j.getDefinitionVersion().getMinor());
			v.append("-");
			v.append(j.getDefinitionVersion().getFix());
